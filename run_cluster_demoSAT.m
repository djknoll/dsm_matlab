...
%							of the DSM elements								*
%																			*
demoSAT_DSM; % enter name of DSM script file
...
% in the original DSM
[DSM_labels] = DSMLABEL; %DSM_autolabel(DSM_matrix);
...
% GRAPH THE MATRICES
current_date = '2016-07-05'; %datestr(now,0);

% Create titles for the graphs
DSM_title = ['Original DSM <' DSMLABEL{1,1} '>  (' current_date ')'];
New_DSM_title = ['Clustered DSM <' DSMLABEL{1,1} '>,  Total Cost: ' num2str(total_coord_cost) '  (' current_date ')'];

% graph the original DSM Matrix
graph_matrix(graph_DSM_matrix,'','',DSM_title, DSM_labels, DSM_labels, print_flag);
...
graph_matrix(graph_New_DSM_matrix,'','',New_DSM_title, New_DSM_labels, New_DSM_labels, print_flag, Cluster_matrix);
...
% graph_matrix(Cluster_matrix,'','Cluster',Cluster_title, DSM_labels, Cluster_label, 0);
